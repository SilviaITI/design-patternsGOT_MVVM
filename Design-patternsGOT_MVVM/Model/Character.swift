...
extension Character {
    static let character0 = Character(id: 0,
                                      firstName: "Daenerys",
                                      lastName: "Targaryen",
...
let characterTest:[Character] = [.character1, .character2, .character3, .character4, .character5, .character6, .character7, .character8, .character9, .character10]
